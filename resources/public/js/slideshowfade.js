...
//======================
 ...
 var imgArray = new Array();
      imgArray[0] = "/img/ils.jpg";
      imgArray[1] = "/img/Untitled-1.jpg";
      imgArray[2] = "/img/Untitled-2.jpg";
      slideshowFade('Slideshow1','',imgArray,5,6000);
...
function slideshowFadeMouseover(id)
{
  if(slideshowFadeAnimate[id]=='run')
  {
    ...
    slideshowFadeCount[id] = (Math.floor(slideshowFadeCount[id]/200)*200)+1;
  }
}
