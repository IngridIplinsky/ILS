(ns tanara.models.estudante.corygil.factor-graph.bayes
  (:use
   tanara.models.estudante.corygil.factor-graph)
  (:import
   [tanara.models.estudante.corygil.factor_graph FNode VNode]))
